  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="px-8 py-10">
        <h2 className="text-3xl font-bold mb-8">🇰🇷 All KDramas</h2>
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <p className="text-red-400 text-xs mt-1">
                    🇰🇷 KDrama · ⭐ {drama.vote_average?.toFixed(1)}
                  </p>
                </div>
              </div>
            ))}
        ...
        <div className="flex justify-center gap-4 mt-10">
          <button
            ...
            disabled={page === 1}
            className="px-6 py-2 bg-gray-800 rounded-lg disabled:opacity-40"
          >
            ← Previous
          </button>

          <span className="px-6 py-2 bg-gray-900 rounded-lg">
            Page {page}
          </span>
